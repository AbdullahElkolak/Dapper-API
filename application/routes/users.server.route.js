...
module.exports = function(app) {
    ...
    app.route('/api/user/avatar').post(passport.authenticate('jwt', {session: false}), users.avatarUpload).get(passport.authenticate('jwt', {session: false}), users.renderAvatarUpload);
